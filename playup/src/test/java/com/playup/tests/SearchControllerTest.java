...
import com.playup.controller.search.SearchController;
...
class SearchControllerTest {
	...
	void searchControllerNotNullTest() throws ClassNotFoundException {
		Class<?> classFinder = Class.forName("com.playup.controller.search.SearchController", false, getClass().getClassLoader());
	...
	void getSearchResultsTest() throws SQLException {
		...
		SearchVenue venue1 = new SearchVenue("2000001", "DalPlex", "Halifax", "5", "10", "8:00:00", "20:00", "902-494-3372",

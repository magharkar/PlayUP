...
public class SupportDao implements ISupportDao{
    ...
    public boolean checkWhetherTicketNumberExists(int ticketNumber) throws SQLException {
        ...
        String sqlQuery = String.format(ApplicationConstants.checkSupportTicketNumberQuery,ticketNumber);
    ...
    public boolean generateSupportRequest(SupportModel supportModel) throws SQLException {
        ...
        String sqlQuery = String.format(ApplicationConstants.insetSupportRequestQuery,supportModel.getTicketNumber(),supportModel.getName(),supportModel.getEmail(),supportModel.getVenue(),supportModel.getDescription());

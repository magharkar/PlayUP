...
public class ApplicationConstants {
    ...
    public final static String adminMailId = "shiv.course@gmail.com";
    public final static String supportEmailBody = "We are really sorry for the issue you faced. Our team will reach out to you regarding the issue.";
